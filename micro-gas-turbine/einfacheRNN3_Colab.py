...
# VERSION: RNN3 - Mit HÖHEREM INITIAL LEARNING RATE (0.01 statt 0.001)
# EXPERIMENTE: Ist ein aggressiverer LR besser?
# ============================================================================

# SCHRITT 0: SETUP FÜR GOOGLE COLAB
print("=" * 80)
print("SCHRITT 0: SETUP FÜR GOOGLE COLAB - RNN3 MIT SCHEDULER (LR=0.01)")
print("=" * 80)
...
# ← RNN3 EXPERIMENTE: HÖHERE INITIAL LR (0.01 statt 0.001)
...
print("🚀 Training gestartet (RNN3 mit LR=0.01)...\n")
...
for epoche in tqdm(range(anzahl_epochen), desc="Epochen", unit="Epoche"):
    ...
    if durchschnittlicher_verlust < bester_verlust:
        ...
        geduld_zaehler = 0
        torch.save(modell.state_dict(), 'einfachesRNN3.pth')
...
files.download('einfachesRNN3.pth')
print("✅ Modell 'einfachesRNN3.pth' heruntergeladen!")

print("\n" + "=" * 80)
print("FERTIG!")
print("=" * 80)
print("Modell ist trainiert und heruntergeladen!")
print("\n🎉 RNN3 (Höhere LR=0.01) ist abgeschlossen!")
print("Vergleiche RMSE mit RNN2 um zu sehen ob aggressiverer LR besser ist!")
