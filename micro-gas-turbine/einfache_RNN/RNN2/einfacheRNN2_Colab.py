...
# VERSION: RNN2 - Mit ReduceLROnPlateau für bessere Konvergenz
# ============================================================================

# SCHRITT 0: SETUP FÜR GOOGLE COLAB
print("=" * 80)
print("SCHRITT 0: SETUP FÜR GOOGLE COLAB - RNN2 MIT SCHEDULER")
print("=" * 80)
...
from torch.optim.lr_scheduler import ReduceLROnPlateau  # ← NOVO: Scheduler import
...
# ReduceLROnPlateau: Wenn der Verlust sich nicht verbessert, wird die LR reduziert
...
geduld_schwelle = 20  # Early Stopping: Zaustavi nakon 20 epoha bez poboljšanja
geduld_zaehler = 0
verlust_geschichte = []

print("🚀 Training gestartet (Early Stopping + Scheduler aktiviert - Scheduler Patience=10)...\n")
...
for epoche in tqdm(range(anzahl_epochen), desc="Epochen", unit="Epoche"):
    ...
    if durchschnittlicher_verlust < bester_verlust:
        ...
        torch.save(modell.state_dict(), 'einfachesRNN2.pth')
    ...
    # ← NOVO: Aufrufen von scheduler.step() mit dem aktuellen Verlust
    # Der Scheduler überprüft: wenn der Verlust sich nicht verbessert hat,
    # wird die Learning Rate reduziert
...
files.download('einfachesRNN2.pth')
print("✅ Modell 'einfachesRNN2.pth' heruntergeladen!")

print("\n" + "=" * 80)
print("FERTIG!")
print("=" * 80)
print("Modell ist trainiert und heruntergeladen!")
print("\n🎉 RNN2 mit Learning Rate Scheduler ist abgeschlossen!")
print("Scheduler hat die Learning Rate angepasst wenn nötig (Patience=10)")
print("Erwartete RMSE Verbesserung gegenüber RNN1!")
