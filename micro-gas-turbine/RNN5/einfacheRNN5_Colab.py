...
# VERSION: RNN5 - Mit 2 LSTM SCHICHTEN (statt 3) - SEICHERES NETZWERK
# EXPERIMENTE: Funktioniert ein seicheres Netzwerk genauso gut?
# ============================================================================

# SCHRITT 0: SETUP FÜR GOOGLE COLAB
print("=" * 80)
print("SCHRITT 0: SETUP FÜR GOOGLE COLAB - RNN5 MIT SCHEDULER (2 LSTM LAGEN)")
print("=" * 80)
...
print("\n" + "=" * 80)
print("SCHRITT 4: RNN-MODELL (2 LSTM LAGEN)")
print("=" * 80)

class EinfachesRNNModell(nn.Module):
    def __init__(self, eingabedimension=1, verstecktedimension=32, anzahl_lstm_schichten=2, ausgabedimension=1):
        super(EinfachesRNNModell, self).__init__()
        # ← RNN5 EXPERIMENTE: NUR 2 LSTM SLOJA (statt 3)
    ...
    def forward(self, x):
        ...
        letzter_wert = ausgabe_lstm2[:, -1, :]  # ← UZMI IZ LSTM2 (nema LSTM3!)
...
print("🚀 Training gestartet (RNN5 mit 2 LSTM Lagen)...\n")
...
for epoche in tqdm(range(anzahl_epochen), desc="Epochen", unit="Epoche"):
    ...
    if durchschnittlicher_verlust < bester_verlust:
        ...
        geduld_zaehler = 0
        torch.save(modell.state_dict(), 'einfachesRNN5.pth')
...
files.download('einfachesRNN5.pth')
print("✅ Modell 'einfachesRNN5.pth' heruntergeladen!")

print("\n" + "=" * 80)
print("FERTIG!")
print("=" * 80)
print("Modell ist trainiert und heruntergeladen!")
print("\n🎉 RNN5 (Seicheres Netzwerk mit 2 LSTM Lagen) ist abgeschlossen!")
print("Vergleiche RMSE mit RNN2 um zu sehen ob seicheres Netzwerk ausreicht!")
